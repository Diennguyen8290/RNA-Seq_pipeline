...
#Downlaod rat genome fasta (sequence) and .gtf (annotation) files from ENSEMBL (identical to GenBank. GENCODE has no rat genome assemblies).
wget ftp://ftp.ensembl.org/pub/release-91/fasta/rattus_norvegicus/dna/
wget ftp://ftp.ensembl.org/pub/release-91/gtf/rattus_norvegicus
